...
void loop() {
  ...
  // Si ambos sensores detectan algo
  if ((Right_Value == 0) && (distance >= 2 && distance <= 30) && (Left_Value == 0)) {
    Motor1.setSpeed(200);
    Motor1.run(FORWARD);
    Motor2.setSpeed(200);
    Motor2.run(FORWARD);
  ...
  // Si solo el sensor derecho detecta algo
  ...
  // Si solo el sensor izquierdo detecta algo
  ...
  // Si ninguno de los sensores detecta algo
